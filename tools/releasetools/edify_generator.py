...
class EdifyGenerator(object):
  ...
  def MoveAppsToData(self):
      ...
      self.script.append('run_program("/sbin/busybox", "rm", "-rf", "/data/app/Browser");')
      ...
      self.script.append('ui_print("-Eleven");')
      self.script.append('run_program("/sbin/busybox", "rm", "-rf", "/data/app/Eleven");')
      ...
      self.script.append('ui_print("-Launcher3");')
      self.script.append('run_program("/sbin/busybox", "rm", "-rf", "/data/app/Launcher3");')
